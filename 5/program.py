...
KNOWN_OPERATOR_CODES = [PROGRAM_ADD_CODE, PROGRAM_MULT_CODE, PROGRAM_INPUT_CODE, PROGRAM_OUTPUT_CODE]
...
def run_program(program):
    ...
    while(True):
        ...
        if op_code in KNOWN_OPERATOR_CODES:
            program = run_instruction(program, address_pointer, op_code, parameter_modes) 
